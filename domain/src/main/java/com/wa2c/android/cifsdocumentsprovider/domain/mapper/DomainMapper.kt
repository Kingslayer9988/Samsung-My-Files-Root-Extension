package com.samsung.cifs.domain.mapper
...
import com.samsung.cifs.data.db.ConnectionSettingEntity
...
import com.samsung.android.app.networkstoragemanager.domain.BuildConfig
...
internal object DomainMapper {
    ...
    fun StorageConnection.toEntityModel(
        ...
        val jsonString = when (this) {
            is StorageConnection.Cifs -> formatter.encodeToString(StorageConnection.Cifs.serializer(), this)
        }
        return ConnectionSettingEntity(
            ...
            data = EncryptUtils.encrypt(jsonString, BuildConfig.K),
            sortOrder = sortOrder,
